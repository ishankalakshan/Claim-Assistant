...
namespace ModelLayer
{
    public class Claim_ML
    {
        ...
        public Claim_ML(int ppolicyId,string plocation, string preason, string pknockedOn, string p_3rdVehicleNo,
                        ...
                        List<SparepartPayment_ML> pspareParts, string pgarageCosts, string potherCosts,string ppaymentNotes, string pdeductions,string pempid)
        {
            try
            {
                if (ppolicyId != null)
