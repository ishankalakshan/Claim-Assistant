...
<asp:Content ID="Content4" ContentPlaceHolderID="cpForm" runat="server">
    ...
    <div class="form-inline">
        <button type="button" class="btn btn-primary horizontal-bar" data-toggle="modal" data-target="#TowTruckServiceModal">
            Add
        </button>
        <button type="button" runat="server" class="btn btn-warning horizontal-bar" onserverclick="btnEdit_Click">
            Edit
        </button>
        <button type="button" class="btn btn-danger horizontal-bar" data-toggle="modal" data-target="#myModal">
            Remove
        </button>
    </div>
